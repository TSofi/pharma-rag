...
window.I18N = (() => {
  const STR = {
    en: {
      ...
      kindSourced: "From the label · sourced", kindGeneral: "General info · not from the labels", kindEmergency: "Urgent",
      metaGeneral: "Not in the loaded labels, so this is general AI knowledge without sources. Check with a doctor or pharmacist.",
      metaEmergency: "Safety first: this was not answered by the AI.",
      legendSrc: "From official labels, with sources", legendGen: "General AI info, no sources",
      ...
      timing: "⏱ search {r} s · AI {l} s · server wake-up/network {w} s",
      ...
      foot1: "Violet answers come from official drug labels: each sentence links to the exact label section. If the labels don't cover a question, you get an orange, clearly marked general answer without sources.",
    ...
    uk: {
      ...
      kindSourced: "З інструкції · з джерелами", kindGeneral: "Загальна довідка · не з інструкцій", kindEmergency: "Терміново",
      metaGeneral: "Цього немає в завантажених інструкціях, тому це загальні знання ШІ без джерел. Уточніть у лікаря чи фармацевта.",
      metaEmergency: "Безпека понад усе: на це питання ШІ не відповідає.",
      legendSrc: "З офіційних інструкцій, з джерелами", legendGen: "Загальна довідка ШІ, без джерел",
      ...
      timing: "⏱ пошук {r} с · ШІ {l} с · пробудження сервера/мережа {w} с",
      ...
      foot1: "Фіолетові відповіді беруться з офіційних інструкцій: кожне речення посилається на конкретний розділ. Якщо в інструкціях цього немає, ви отримаєте помаранчеву, чітко позначену загальну довідку без джерел.",
    ...
    pl: {
      ...
      kindSourced: "Z ulotki · ze źródłami", kindGeneral: "Informacja ogólna · nie z ulotek", kindEmergency: "Pilne",
      metaGeneral: "Tego nie ma w załadowanych ulotkach, więc to ogólna wiedza AI bez źródeł. Skonsultuj się z lekarzem lub farmaceutą.",
      metaEmergency: "Bezpieczeństwo przede wszystkim: AI nie odpowiada na to pytanie.",
      legendSrc: "Z oficjalnych ulotek, ze źródłami", legendGen: "Ogólna informacja AI, bez źródeł",
      ...
      timing: "⏱ wyszukiwanie {r} s · AI {l} s · wybudzanie serwera/sieć {w} s",
      ...
      foot1: "Fioletowe odpowiedzi pochodzą z oficjalnych ulotek: każde zdanie odsyła do konkretnej sekcji. Jeśli ulotki tego nie obejmują, dostaniesz pomarańczową, wyraźnie oznaczoną ogólną odpowiedź bez źródeł.",
